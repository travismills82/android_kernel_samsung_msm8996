...
DEFCONFIG=$1/hero2qlte_chnzh_defconfig
...
FUNC_BUILD_DTB()
{
		...
		$DTBTOOL -v -s 4096 -o $TEMP_DIR/dtb $DTS_DIR/
}
...
FUNC_PACK()
{
		...
		cp $BUILDING_DIR/arch/arm64/boot/Image.gz $TEMP_DIR/split_img/boot.img-zImage
